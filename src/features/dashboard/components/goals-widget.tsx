    ...
    <Card className="bg-white/[0.03] backdrop-blur-xl border-white/[0.08] rounded-3xl">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div>
            <span className="text-[10px] uppercase font-bold text-indigo-400 tracking-wider">Targets</span>
      ...
      <CardContent className="p-6 pt-0 space-y-4">
        {goals.length === 0 ? (
          ...
          goals.map((g) => {
            ...
            return (
              <div key={g.goalId} className="space-y-1.5 p-3.5 bg-white/[0.01] border border-white/[0.04] rounded-2xl hover:border-white/[0.08] transition-all">
